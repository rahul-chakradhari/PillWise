...
const Home = () => {
  ...
  return (
    <div className="container">
      ...
      <div className="text">
        <div className="title">PillWise</div>

        <div className="texts">
          <b>
            {" "}
            1. Stay on Track with PillWise! 🚀 <br />
          </b>
          ...
          <br />
          <div className="subtexts">
            PillWise helps you manage your medications 💊 and stay healthy
            effortlessly. ✅<br />
          </div>
          ...
          <b>
            4. PillWise – Your Personal Health Assistant 🤖 <br />
          </b>
          <div className="subtexts">
