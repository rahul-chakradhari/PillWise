...
const rewards = [
  {
    ...
    img: "/gastro1.jpg",
    description:
      "MBBS, MS (Orthopedics) - Gastroenterologist\n\nDr. Rajesh Verma is an expert orthopedic surgeon known for his proficiency in joint replacements, fracture treatments, and sports injury rehabilitation. He emphasizes personalized care and modern surgical techniques for faster recovery. Appointment fees",
    points: 2000, // Numeric value
    fees: "Appointment Fees: 2000 ₹", // Proper key-value pair
  },
